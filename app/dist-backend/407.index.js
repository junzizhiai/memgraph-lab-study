...
/* harmony import */ var _messages_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(20596);
/* harmony import */ var _prompt_values_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(42526);
/* harmony import */ var _runnables_base_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(22042);
/* harmony import */ var _string_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(90148);
/* harmony import */ var _base_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(24095);
/* harmony import */ var _prompt_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(64266);
/* harmony import */ var _image_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(15213);
/* harmony import */ var _template_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(65687);
 ...
 * conversation.
 */
class BaseMessagePromptTemplate extends _runnables_base_js__WEBPACK_IMPORTED_MODULE_2__/* .Runnable */ .eq {
    constructor() {
        super(...arguments);
 ...
 */
class BaseChatPromptTemplate extends _base_js__WEBPACK_IMPORTED_MODULE_4__/* .BasePromptTemplate */ .d {
    constructor(input) {
        super(input);
    }
    async format(values) {
    ...
    async formatPromptValue(values) {
        ...
        return new _prompt_values_js__WEBPACK_IMPORTED_MODULE_1__/* .ChatPromptValue */ .GU(resultMessages);
    }
}
/**
...
class ChatMessagePromptTemplate extends BaseMessageStringPromptTemplate {
    ...
    async format(values) {
        return new _messages_index_js__WEBPACK_IMPORTED_MODULE_0__/* .ChatMessage */ .J(await this.prompt.format(values), this.role);
    }
...
class _StringImageMessagePromptTemplate extends BaseMessagePromptTemplate {
        ...
        for (const item of template) {
            if (typeof item === "string" ||
                ...
                if (typeof imgTemplate === "string") {
                    const parsedTemplate = (0,_template_js__WEBPACK_IMPORTED_MODULE_7__/* .parseFString */ ._O)(imgTemplate);
                    ...
                    imgTemplateObject = new _image_js__WEBPACK_IMPORTED_MODULE_6__/* .ImagePromptTemplate */ .r({
                    ...
                    if ("url" in imgTemplate) {
                        const parsedTemplate = (0,_template_js__WEBPACK_IMPORTED_MODULE_7__/* .parseFString */ ._O)(imgTemplate.url);
    ...
    async format(input) {
        ...
        if (this.prompt instanceof _string_js__WEBPACK_IMPORTED_MODULE_3__/* .BaseStringPromptTemplate */ .A) {
            ...
            for (const prompt of this.prompt) {
                ...
                // eslint-disable-next-line no-instanceof/no-instanceof
                if (prompt instanceof _string_js__WEBPACK_IMPORTED_MODULE_3__/* .BaseStringPromptTemplate */ .A) {
                    const formatted = await prompt.format(inputs);
                    content.push({ type: "text", text: formatted });
                    /** @TODO replace this */
                    // eslint-disable-next-line no-instanceof/no-instanceof
                }
                else if (prompt instanceof _image_js__WEBPACK_IMPORTED_MODULE_6__/* .ImagePromptTemplate */ .r) {
                    const formatted = await prompt.format(inputs);
...
class HumanMessagePromptTemplate extends _StringImageMessagePromptTemplate {
    static _messageClass() {
        return _messages_index_js__WEBPACK_IMPORTED_MODULE_0__/* .HumanMessage */ .xk;
    }
    static lc_name() {
...
class AIMessagePromptTemplate extends _StringImageMessagePromptTemplate {
    static _messageClass() {
        return _messages_index_js__WEBPACK_IMPORTED_MODULE_0__/* .AIMessage */ .gY;
    }
    static lc_name() {
...
class SystemMessagePromptTemplate extends _StringImageMessagePromptTemplate {
    static _messageClass() {
        return _messages_index_js__WEBPACK_IMPORTED_MODULE_0__/* .SystemMessage */ .jN;
    }
    static lc_name() {
...
function _coerceMessagePromptTemplateLike(messagePromptTemplateLike) {
    if (_isBaseMessagePromptTemplate(messagePromptTemplateLike) ||
        (0,_messages_index_js__WEBPACK_IMPORTED_MODULE_0__/* .isBaseMessage */ .QW)(messagePromptTemplateLike)) {
        return messagePromptTemplateLike;
    }
    const message = (0,_messages_index_js__WEBPACK_IMPORTED_MODULE_0__/* .coerceMessageLikeToMessage */ .E1)(messagePromptTemplateLike);
    ...
    else if (_messages_index_js__WEBPACK_IMPORTED_MODULE_0__/* .ChatMessage.isInstance */ .J.isInstance(message)) {
    ...
    constructor(input) {
        ...
        if (this.validateTemplate) {
            ...
            for (const promptMessage of this.promptMessages) {
                // eslint-disable-next-line no-instanceof/no-instanceof
                if (promptMessage instanceof _messages_index_js__WEBPACK_IMPORTED_MODULE_0__/* .BaseMessage */ .ku)
                    continue;
...
/* harmony import */ var _prompt_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(64266);
/* harmony import */ var _chat_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(68411);
 ...
 * ```
 */
class FewShotPromptTemplate extends _string_js__WEBPACK_IMPORTED_MODULE_0__/* .BaseStringPromptTemplate */ .A {
    constructor(input) {
        super(input);
        Object.defineProperty(this, "lc_serializable", {
            enumerable: true,
 ...
 */
class FewShotChatMessagePromptTemplate extends _chat_js__WEBPACK_IMPORTED_MODULE_3__/* .BaseChatPromptTemplate */ .S {
    _getPromptType() {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "r": () => (/* binding */ ImagePromptTemplate)
/* harmony export */ });
...
/* harmony import */ var _template_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(65687);
 ...
 */
class ImagePromptTemplate extends _base_js__WEBPACK_IMPORTED_MODULE_1__/* .BasePromptTemplate */ .d {
    static lc_name() {
    ...
    constructor(input) {
        ...
        if (this.validateTemplate) {
            ...
            (0,_template_js__WEBPACK_IMPORTED_MODULE_2__/* .checkValidTemplate */ .af)([
    ...
    async formatPromptValue(values) {
        ...
        return new _prompt_values_js__WEBPACK_IMPORTED_MODULE_0__/* .ImagePromptValue */ .Nn(formattedPrompt);
    }
}
